...
class PdfViewPage2 extends StatefulWidget {
  ...
  const PdfViewPage2({Key key, this.path}) : super(key: key);
  @override
  _PdfViewPage2State createState() => _PdfViewPage2State();
}

class _PdfViewPage2State extends State<PdfViewPage2> {
  bool pdfReady = false;
  int _totalPages = 0;
  int _currentPage = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        elevation: 0,
        title: Text('Quran with Urdu translation',
            style: TextStyle(
                color: Colors.black,
                fontSize: 18,
