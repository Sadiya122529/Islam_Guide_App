...
class LaylatulQadr extends StatefulWidget {
  @override
  _LaylatulQadrState createState() => _LaylatulQadrState();
}

class _LaylatulQadrState extends State<LaylatulQadr> {
  @override
