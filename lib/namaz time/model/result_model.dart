...
import 'package:islam_guide/namaz%20time/model/location_model.dart';
import 'package:islam_guide/namaz%20time/model/setting_model.dart';
...
class ResultModel {
  ...
  ResultModel.parseJson(Map<String, dynamic> data) {
    _locationModel = data['location'] != null
        ? LocationModel.parseJson(data['location'])
        : null;
    _settingModel = data['settings'] != null
        ? SettingModel.parseJson(data['settings'])
        : null;
